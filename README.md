...
##### Download and run the [main script](https://github.com/andyinman/panssh/raw/refs/tags/latest/panssh)

```
curl -so panssh https://github.com/andyinman/panssh/raw/refs/tags/latest/panssh
chmod +x panssh
./panssh
```
...
* 1.2.1:
  * Added [.lando.panssh.yml](https://github.com/andyinman/panssh/raw/refs/tags/latest/lando/.lando.panssh.yml), which provides [easy setup](https://github.com/andyinman/panssh/raw/refs/tags/latest/lando/README.md) of PanSSH in a [Lando](https://lando.dev/) project.
...
Clone the [PanSSH repository](https://github.com/andyinman/panssh) or download and unzip the [zip archive](https://github.com/andyinman/panssh/archive/refs/tags/latest.zip).
