...
```
curl -so https://raw.githubusercontent.com/andy-netgenius/panssh/latest/panssh
chmod +x panssh
./panssh
```
...
Clone the [PanSSH repository](https://github.com/andy-netgenius/panssh) or download and unzip the [zip archive](./archive/refs/tags/latest.zip).
